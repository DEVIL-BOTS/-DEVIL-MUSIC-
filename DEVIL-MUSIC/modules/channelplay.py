...
from DEVIL-MUSIC.modules.play import generate_cover
from DEVIL-MUSIC.modules.play import arq
from DEVIL-MUSIC.modules.play import cb_admin_check
from DEVIL-MUSIC.modules.play import transcode
from DEVIL-MUSIC.modules.play import convert_seconds
from DEVIL-MUSIC.modules.play import time_to_seconds
from DEVIL-MUSIC.modules.play import changeImageSize
from DEVIL-MUSIC.config import BOT_NAME as bn
from DEVIL-MUSIC.config import DURATION_LIMIT
from DEVIL-MUSIC.config import UPDATES_CHANNEL as updateschannel
from DEVIL-MUSIC.config import que
from DEVIL-MUSIC.function.admins import admins as a
from DEVIL-MUSIC.helpers.errors import DurationLimitError
from DEVIL-MUSIC.helpers.decorators import errors
from DEVIL-MUSIC.helpers.admins import get_administrators
from DEVIL-MUSIC.helpers.channelmusic import get_chat_id
from DEVIL-MUSIC.helpers.decorators import authorized_users_only
from DEVIL-MUSIC.helpers.filters import command
from DEVIL-MUSIC.helpers.filters import other_filters
from DEVIL-MUSIC.helpers.gets import get_file_name
from DEVIL-MUSIC.services.callsmusic import callsmusic
from DEVIL-MUSIC.services.callsmusic import client as USER
from DEVIL-MUSIC.services.converter.converter import convert
from DEVIL-MUSIC.services.downloaders import youtube
from DEVIL-MUSIC.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/bfdae5228dbe6d1c92f93.jpg"
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @DEVIL_VC_ASSISTANT to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
